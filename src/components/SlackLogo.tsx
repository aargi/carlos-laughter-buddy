// Official multicolored Slack logo (brand colors #36C5F0, #2EB67D, #ECB22E, #E01E5A).
export function SlackLogo({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 122.8 122.8" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden="true">
